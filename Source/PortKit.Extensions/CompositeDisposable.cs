...
// https://github.com/dotnet/reactive/blob/3cbc73ffac59e14e67c1fb638e2d086f740047df/Rx.NET/Source/src/System.Reactive/Disposables/CompositeDisposable.cs
    ...
    public sealed class CompositeDisposable : ICollection<IDisposable>, IDisposable
    {
        ...
        private void Init(IEnumerable<IDisposable> disposables, int capacityHint)
        {
            ...
            foreach (var d in disposables)
            {
                if (d == null)
                {
                    throw new ArgumentException("Composition cannot contain null element.", nameof(disposables));
                }
